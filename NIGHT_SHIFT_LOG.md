...
[2026-04-28T00:30:00Z] [night-coder] T30 STValidation alloc cap: added MAX_STVALIDATION_BYTES=32 KiB const, capped Vec::with_capacity at .min(MAX_STVALIDATION_BYTES), upfront reject when payload.len() > 2*MAX, +1 regression test decode_validation_caps_oversize_signing_payload_alloc (16 MiB blob rejected). Audit pass 1 H9 closed. cargo test -p rxrpl-overlay green (242 tests).

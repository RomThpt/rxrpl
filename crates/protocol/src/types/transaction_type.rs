...
impl TransactionType {
    ...
    pub fn from_code(code: u16) -> Result<Self, ProtocolError> {
        match code {
            ...
            54 => Ok(Self::MPTokenIssuanceCreate),
            55 => Ok(Self::MPTokenIssuanceDestroy),
            56 => Ok(Self::MPTokenIssuanceSet),
            57 => Ok(Self::MPTokenAuthorize),
            58 => Ok(Self::CredentialCreate),
            59 => Ok(Self::CredentialAccept),
            60 => Ok(Self::CredentialDelete),
            61 => Ok(Self::NFTokenModify),
            62 => Ok(Self::PermissionedDomainSet),
            63 => Ok(Self::PermissionedDomainDelete),
            64 => Ok(Self::DelegateSet),
            65 => Ok(Self::VaultCreate),
            66 => Ok(Self::VaultSet),
            67 => Ok(Self::VaultDelete),
            68 => Ok(Self::VaultDeposit),
            69 => Ok(Self::VaultWithdraw),
            70 => Ok(Self::VaultClawback),
            71 => Ok(Self::BatchSubmit),
            74 => Ok(Self::LoanBrokerSet),
            75 => Ok(Self::LoanBrokerDelete),
            76 => Ok(Self::LoanBrokerCoverDeposit),
            77 => Ok(Self::LoanBrokerCoverWithdraw),
            78 => Ok(Self::LoanBrokerCoverClawback),
            80 => Ok(Self::LoanSet),
            81 => Ok(Self::LoanDelete),
            82 => Ok(Self::LoanManage),
            84 => Ok(Self::LoanPay),
    ...
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            Self::NFTokenModify => "NFTokenModify",
            ...
            Self::VaultSet => "VaultSet",
            Self::VaultDelete => "VaultDelete",
            Self::VaultDeposit => "VaultDeposit",
            Self::VaultWithdraw => "VaultWithdraw",
            Self::VaultClawback => "VaultClawback",
            Self::BatchSubmit => "BatchSubmit",
            Self::LoanBrokerSet => "LoanBrokerSet",
            Self::LoanBrokerDelete => "LoanBrokerDelete",
            Self::LoanBrokerCoverDeposit => "LoanBrokerCoverDeposit",
            Self::LoanBrokerCoverWithdraw => "LoanBrokerCoverWithdraw",
            Self::LoanBrokerCoverClawback => "LoanBrokerCoverClawback",
            Self::LoanSet => "LoanSet",
            Self::LoanDelete => "LoanDelete",
            Self::LoanManage => "LoanManage",
    ...
    pub fn from_name(name: &str) -> Result<Self, ProtocolError> {
        match name {
            ...
            "AMMClawback" => Ok(Self::AMMClawback),
            ...
            "NFTokenModify" => Ok(Self::NFTokenModify),
            "PermissionedDomainSet" => Ok(Self::PermissionedDomainSet),
            "PermissionedDomainDelete" => Ok(Self::PermissionedDomainDelete),
            "DelegateSet" => Ok(Self::DelegateSet),
            "VaultCreate" => Ok(Self::VaultCreate),
            "VaultSet" => Ok(Self::VaultSet),
            "VaultDelete" => Ok(Self::VaultDelete),
            "VaultDeposit" => Ok(Self::VaultDeposit),
            "VaultWithdraw" => Ok(Self::VaultWithdraw),
            "VaultClawback" => Ok(Self::VaultClawback),
            "BatchSubmit" => Ok(Self::BatchSubmit),
            "LoanBrokerSet" => Ok(Self::LoanBrokerSet),
            "LoanBrokerDelete" => Ok(Self::LoanBrokerDelete),
            "LoanBrokerCoverDeposit" => Ok(Self::LoanBrokerCoverDeposit),
            "LoanBrokerCoverWithdraw" => Ok(Self::LoanBrokerCoverWithdraw),
            "LoanBrokerCoverClawback" => Ok(Self::LoanBrokerCoverClawback),
            "LoanSet" => Ok(Self::LoanSet),
            "LoanDelete" => Ok(Self::LoanDelete),
            "LoanManage" => Ok(Self::LoanManage),
            "LoanPay" => Ok(Self::LoanPay),
